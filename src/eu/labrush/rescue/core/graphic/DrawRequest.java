 ...
 *
 * Les méthodes de dessin de DrawRequest sont basées en partie sur les fonctions de référence
 * du logiciel Processing
 * https://processing.org/reference/
 * 
 * S'il vous manque une fonction n'hésitez pas à l'imlémenter,
 * en suivant la nomenclature processing si possible
 * 
 * Javadoc Graphic2D
